...
echo "----------------BLEU----------------"
python utils/tokenizer.py checkpoints/bart_$1_$2.0.0 data/$1/outputs/bart_$1_$2.0.0 False
python utils/tokenizer.py checkpoints/bart_$1_$2.0.1 data/$1/outputs/bart_$1_$2.0.1 False
